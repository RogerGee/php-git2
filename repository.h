...
static constexpr auto GIT_REPOSITORY_NEW = zif_php_git2_function<
    php_git2::func_wrapper<
        int,
...
static constexpr auto GIT_REPOSITORY_OPEN = zif_php_git2_function<
    php_git2::func_wrapper<
        int,
        git_repository**,
...
static constexpr auto _GIT_REPOSITORY_OPEN_BARE_ = zif_php_git2_function<
    php_git2::func_wrapper<
        int,
        git_repository**,
...
#define GIT_REPOSITORY_FE \
    ...
    PHP_GIT2_FE(git_repository_new,GIT_REPOSITORY_NEW,NULL)             \
    PHP_GIT2_FE(git_repository_free,GIT_REPOSITORY_FREE,NULL)           \
    PHP_GIT2_FE(git_repository_open,GIT_REPOSITORY_OPEN,NULL)           \
    PHP_GIT2_FE(git_repository_open_bare,_GIT_REPOSITORY_OPEN_BARE_,NULL)
