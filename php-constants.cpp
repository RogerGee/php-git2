...
void php_git2::php_git2_register_constants(int module_number)
{
    ...
    PHP_GIT2_CONSTANT(GIT_MERGE_DRIVER_VERSION);
    ...
    PHP_GIT2_CONSTANT(GIT_MERGE_OPTIONS_VERSION);
    ...
    PHP_GIT2_CONSTANT(GIT_DESCRIBE_OPTIONS_VERSION);
    PHP_GIT2_CONSTANT(GIT_DESCRIBE_FORMAT_OPTIONS_VERSION);
    ...
    PHP_GIT2_CONSTANT(GIT_PROXY_OPTIONS_VERSION);
