...
static constexpr auto ZIF_GIT_INDEX_ENTRYCOUNT = zif_php_git2_function<
    ...
    >;
/*
static constexpr auto ZIF_GIT_INDEX_ENTRY_IS_CONFLICT = zif_php_git2_function<
    php_git2::func_wrapper<

        >::func<git_index_entry_is_conflict>,
    php_git2::local_pack<
...
static constexpr auto ZIF_GIT_INDEX_FREE = zif_php_git2_function_free<
    ...
    >;
/*
static constexpr auto ZIF_GIT_INDEX_GET_BYINDEX = zif_php_git2_function<
    php_git2::func_wrapper<

        >::func<git_index_get_byindex>,
    php_git2::local_pack<
...
static constexpr auto ZIF_GIT_INDEX_GET_BYPATH = zif_php_git2_function<
    php_git2::func_wrapper<

        >::func<git_index_get_bypath>,
    php_git2::local_pack<
...
#define GIT_INDEX_FE                                                    \
    PHP_GIT2_UNIMPLEMENTED(git_index_add,ZIF_GIT_INDEX_ADD,NULL)        \
    PHP_GIT2_UNIMPLEMENTED(git_index_add_all,ZIF_GIT_INDEX_ADD_ALL,NULL) \
    PHP_GIT2_FE(git_index_add_bypath,ZIF_GIT_INDEX_ADD_BYPATH,NULL)     \
    PHP_GIT2_UNIMPLEMENTED(git_index_add_frombuffer,ZIF_GIT_INDEX_ADD_FROMBUFFER,NULL) \
    ...
    PHP_GIT2_UNIMPLEMENTED(git_index_conflict_add,ZIF_GIT_INDEX_CONFLICT_ADD,NULL) \
    PHP_GIT2_FE(git_index_conflict_cleanup,ZIF_GIT_INDEX_CONFLICT_CLEANUP,NULL) \
    PHP_GIT2_UNIMPLEMENTED(git_index_conflict_get,ZIF_GIT_INDEX_CONFLICT_GET,NULL) \
    ...
    PHP_GIT2_UNIMPLEMENTED(git_index_entry_is_conflict,ZIF_GIT_INDEX_ENTRY_IS_CONFLICT,NULL) \
    PHP_GIT2_UNIMPLEMENTED(git_index_entry_stage,ZIF_GIT_INDEX_ENTRY_STAGE,NULL) \
    ...
    PHP_GIT2_UNIMPLEMENTED(git_index_get_byindex,ZIF_GIT_INDEX_GET_BYINDEX,NULL) \
    PHP_GIT2_UNIMPLEMENTED(git_index_get_bypath,ZIF_GIT_INDEX_GET_BYPATH,NULL) \
    ...
    PHP_GIT2_UNIMPLEMENTED(git_index_remove_all,ZIF_GIT_INDEX_REMOVE_ALL,NULL) \
    ...
    PHP_GIT2_UNIMPLEMENTED(git_index_update_all,ZIF_GIT_INDEX_UPDATE_ALL,NULL) \
